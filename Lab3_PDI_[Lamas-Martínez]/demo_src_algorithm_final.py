...
while a == 1:
        if opcion == 1:
                print("\n Capturando Imagen ...\n")
                time.sleep(3)
                img = cam.getImage().save("imgdemo.png")
                print("\n Desea Capturarla nuevamente?\n1. Si   \n2. No\n\n Eleccion: \n")
		opcion = input()
		if opcion == 1:
			continue
		elif opcion == 2:
...
print("\n Ingrese parametro de tolerancia: \n")
epsilon = input()
...
print("\n Finalizando... \n")
scipy.misc.imsave('edges_mask_imgdemo.png', Edges)
img.save("edges_imgdemo_with_src-algorithm.png")
